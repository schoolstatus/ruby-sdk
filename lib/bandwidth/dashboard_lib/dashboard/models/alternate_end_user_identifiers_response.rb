...
module Bandwidth
  # AlternateEndUserIdentifiersResponse Model.
  class AlternateEndUserIdentifiersResponse < BaseModel
    ...
    def self.from_hash(hash)
      ...
      payload = AlternateEndUserIdentifiers.from_hash(hash['payload']) if
        hash['payload']
      ...
      AlternateEndUserIdentifiersResponse.new(payload,
                                              pagination_links,
                                              total_count)
    end

    def self.from_element(root)
      payload = XmlUtilities.from_element(root, 'AlternateEndUserIdentifiers',
    ...
    def to_xml_element(doc, root_name)
      ...
      XmlUtilities.add_as_subelement(doc, root, 'AlternateEndUserIdentifiers',
                                     payload)
