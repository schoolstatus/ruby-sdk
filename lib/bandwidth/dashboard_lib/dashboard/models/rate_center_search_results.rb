...
module Bandwidth
  # RateCenterSearchResults Model.
  class RateCenterSearchResults < BaseModel
    # TODO: Write general description for this method
    # @return [SearchError]
    attr_accessor :search_error

    # TODO: Write general description for this method
    # @return [List of RateCenterSearchResult]
    ...
    def self.from_hash(hash)
      ...
      unless hash['resultSet'].nil?
        ...
        hash['resultSet'].each do |structure|
          result_set << (RateCenterSearchResult.from_hash(structure) if structure)
        end
      end
      ...
      RateCenterSearchResults.new(search_error,
                                  result_set,
                                  result_size,
                                  status,
    ...
    def self.from_element(root)
      ...
      result_set = XmlUtilities.from_element_to_array(
        root, 'RateCenter', RateCenterSearchResult,
    ...
    def to_xml_element(doc, root_name)
      ...
      XmlUtilities.add_array_as_subelement(doc, root, 'RateCenter', result_set,
                                           wrapping_element_name: 'RateCenters')
