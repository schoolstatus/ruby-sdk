...
module Bandwidth
  # SipPeerTelephoneNumberWarningPayload Model.
  class SipPeerTelephoneNumberWarningPayload < BaseModel
    ...
    def self.from_hash(hash)
      ...
      SipPeerTelephoneNumberWarningPayload.new(telephone_number,
                                               description)
    end
