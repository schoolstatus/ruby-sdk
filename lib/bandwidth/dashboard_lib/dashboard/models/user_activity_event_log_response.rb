...
module Bandwidth
  # UserActivityEventLogResponse Model.
  class UserActivityEventLogResponse < BaseModel
    ...
    def self.from_hash(hash)
      ...
      payload = UserActivityEvents.from_hash(hash['payload']) if
        hash['payload']
      pagination_links = PaginationLinks.from_hash(hash['paginationLinks']) if
        hash['paginationLinks']

      # Create object from extracted values.
      UserActivityEventLogResponse.new(payload,
                                       pagination_links)
    end

    def self.from_element(root)
      payload = XmlUtilities.from_element(root, 'UserEvents',
                                          UserActivityEvents)
    ...
    def to_xml_element(doc, root_name)
      ...
      XmlUtilities.add_as_subelement(doc, root, 'UserEvents', payload)
