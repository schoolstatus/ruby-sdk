...
module Bandwidth
  # LidbOrderPayload Model.
  class LidbOrderPayload < BaseModel
    ...
    # TODO: Write general description for this method
    # @return [List of LidbDetailTnGroup]
    attr_accessor :lidb_detail_tn_groups

    # TODO: Write general description for this method
    # @return [List of LidbOrderError]
    ...
    def self.names
      ...
      @_hash['lidb_detail_tn_groups'] = 'lidbDetailTnGroups'
      @_hash['errors'] = 'errors'
      @_hash
    end
    ...
    def initialize(id = nil,
      ...
      @lidb_detail_tn_groups = lidb_detail_tn_groups
      @errors = errors
    end
    ...
    def self.from_hash(hash)
      ...
      lidb_detail_tn_groups = nil
      unless hash['lidbDetailTnGroups'].nil?
        lidb_detail_tn_groups = []
        hash['lidbDetailTnGroups'].each do |structure|
          lidb_detail_tn_groups << (LidbDetailTnGroup.from_hash(structure) if structure)
        end
      end
      # Parameter is an array, so we need to iterate through it
      errors = nil
      unless hash['errors'].nil?
        ...
        hash['errors'].each do |structure|
          errors << (LidbOrderError.from_hash(structure) if structure)
        end
      end

      # Create object from extracted values.
      LidbOrderPayload.new(id,
                           account_id,
                           name,
    ...
    def self.from_element(root)
      ...
      processing_status = XmlUtilities.from_element(root, 'ProcessingStatus',
                                                    String)
      lidb_detail_tn_groups = XmlUtilities.from_element_to_array(
        root, 'LidbTnGroup', LidbDetailTnGroup,
        wrapping_element_name: 'LidbTnGroups'
      )
      errors = XmlUtilities.from_element_to_array(
        root, 'Error', LidbOrderError,
    ...
    def to_xml_element(doc, root_name)
      ...
      XmlUtilities.add_array_as_subelement(
        doc, root, 'LidbTnGroup', lidb_detail_tn_groups,
        wrapping_element_name: 'LidbTnGroups'
      )
