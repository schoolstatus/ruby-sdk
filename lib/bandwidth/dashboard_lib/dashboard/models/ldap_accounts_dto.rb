...
module Bandwidth
  # LdapAccountsDto Model.
  class LdapAccountsDto < BaseModel
    # TODO: Write general description for this method
    # @return [Integer]
    attr_accessor :total_count

    # TODO: Write general description for this method
    # @return [List of LdapAccount]
    ...
    def self.from_hash(hash)
      ...
      unless hash['accounts'].nil?
        ...
        hash['accounts'].each do |structure|
          accounts << (LdapAccount.from_hash(structure) if structure)
        end
      end

      # Create object from extracted values.
      LdapAccountsDto.new(total_count,
                          accounts)
    end
