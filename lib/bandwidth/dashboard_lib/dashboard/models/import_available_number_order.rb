...
module Bandwidth
  # ImportAvailableNumberOrder Model.
  class ImportAvailableNumberOrder < BaseModel
    ...
    # TODO: Write general description for this method
    # @return [ImportAvailableNumberOrderType]
    ...
    def self.from_hash(hash)
      ...
      if hash['orderType']
        order_type = ImportAvailableNumberOrderType.from_hash(hash['orderType'])
      end

      # Create object from extracted values.
      ImportAvailableNumberOrder.new(id,
                                     name,
                                     last_modified_by,
                                     customer_order_id,
                                     site_id,
