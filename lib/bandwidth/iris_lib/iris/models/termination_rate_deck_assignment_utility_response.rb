...
module Bandwidth
  # TerminationRateDeckAssignmentUtilityResponse Model.
  class TerminationRateDeckAssignmentUtilityResponse < BaseModel
    ...
    def self.from_hash(hash)
      ...
      TerminationRateDeckAssignmentUtilityResponse.new(payload)
    end
