...
module Bandwidth
  # EmergencyNotificationGroupsEndpointAssociationResponse Model.
  class EmergencyNotificationGroupsEndpointAssociationResponse < BaseModel
    # TODO: Write general description for this method
    # @return [EmergencyNotificationGroupsEndpointAssociationPayload]
    ...
    def self.from_hash(hash)
      ...
      if hash['payload']
        payload = EmergencyNotificationGroupsEndpointAssociationPayload.from_hash(hash['payload'])
      end
      pagination_links = PaginationLinks.from_hash(hash['paginationLinks']) if
        hash['paginationLinks']

      # Create object from extracted values.
      EmergencyNotificationGroupsEndpointAssociationResponse.new(payload,
                                                                 pagination_links)
    end

    def self.from_element(root)
      payload = XmlUtilities.from_element(
        root, 'EmergencyNotificationEndpointOrders',
